...
```javascript
// Basic Information
valentineName: " Ayachi Mahendia "                    // Your Valentine's name
...
questions: {
    ...
    second: {
        text: "How much do you love me betuu?",          // Second question
        startText: "This much!",                   // Text before percentage
        nextBtn: "Next ❤️"                         // Next button text
    },
    third: {
        text: "Will you be my Valentine achu babyyyyy...?",      // Final question
        yesBtn: "Yes!",                            // Yes button text
        noBtn: "No"                                // No button text
    }
}
